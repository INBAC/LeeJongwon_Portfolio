...
<html>
<head>
  <link href="css/notice_css.css" type="text/css" rel="stylesheet">
...
<body>
    ...
    <div class="main">
      ...
      <div class="top_area">
          <div class="notice_type">
              <ul>
                <li><a target="_self" href="notice.php">전체</a></li>
                <li><a target="_self" href="notice.php?sort=<?php $sort = 'mse'; echo $sort?>">학과공지</a></li>
                <li><a target="_self" href="notice.php?sort=<?php $sort = 'recruiting'; echo $sort?>">취업공지</a></li>
                <li><a target="_self" href="notice.php?sort=<?php $sort = 'class'; echo $sort?>">수업공지</a></li>
              </ul>
          </div>
      </div>
      ...
      <?php
      if($user_id){?>
      <a href="newnotice.php" class="new_notice">
  ...
  for( ;  ; $i++){
	...
	$mysqli = mysqli_connect('localhost', 'junmo14', 'mse','MSE');$check = "SELECT * FROM board WHERE pin = TRUE";
  ...
  <tr>
          ...
          <td width="500" class="pin_list_title"><a href='notice_click.php?id=<?php echo $id?>'><?php
...
?>
      ...
      if($current_page != 0){?>
        ...
        for($i = 0; $i < $page_num; $i++)
        {
          ...
          {?>
            <a href="notice.php?sort=<?php echo $sort?>&page_number=<?php echo $i?>&search_value=<?php echo $search?>" class="page_mid"><?php echo $i+1?></a><?php
          }
        }
